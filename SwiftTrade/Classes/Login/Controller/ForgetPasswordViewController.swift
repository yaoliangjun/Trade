...
class ForgetPasswordViewController: BaseViewController {
    ...
    override func setupSubViews() {
        ...
        //
        let titleLabel = UILabel(text: "找回密码", textAlignment: .center, textColor: AppConstants.goldColor, font: UIFont.systemFont(ofSize: 20))
        ...
        // 确定
        let confirmBtn = CommonButton(title: "确定", font: UIFont.systemFont(ofSize: 18), target: self, selector: #selector(confirmBtnClick))
